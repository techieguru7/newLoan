...
export class AppComponent {
  ...
  constructor(private titleService: Title,
    ...
    this.metaTagService.addTags([
      { name: 'description', content: 'EMI Calculator - Calculate Equated Monthly Installment (EMI) for Home Loan / Housing Loan, Car Loan &amp; Personal Loan' },
      { name: 'keywords', content: 'emi Calculator,emi,loan,home loan,emi,Loan,calculator,calc, car loan, personal loan,home loan emi,mortgage lenders,bank loan,calculator' },
